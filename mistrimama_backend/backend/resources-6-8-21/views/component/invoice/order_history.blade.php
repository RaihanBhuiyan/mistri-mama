            ...
            <table style="margin-bottom: 20px; border-bottom: 1px solid #000;">
                <thead>
                    <tr style="background-color: #000;">
                        ...
                        <th style="font-size: 12px; color: #fff; padding: 5px 15px;">Additional Unit</th>
                        <th style="font-size: 12px; color: #fff; padding: 5px 15px;">Additional Unit Price</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 10px;" align="center">{{ $item->total_aditional_unit }}</td>
                        <td style="font-size: 10px;" align="center">{{ $item->total_aditional_unit_price }}</td>
