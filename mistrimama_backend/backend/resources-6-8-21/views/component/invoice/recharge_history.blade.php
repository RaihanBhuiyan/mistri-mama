...
<html lang="en">
    ...
    <body>
        <header class="clearfix">
            ...
            <h3 style="text-align: center; margin-bottom: 30px; border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 5px 0;">RECHARGE HISTORY</h3>
        </header>
        @if(!empty($recharge_histories))
        <main>
            <table style="margin-bottom: 20px; border-bottom: 1px solid #000;">
                <thead>
                    <tr style="background-color: #000;">
                        ...
                        <th style="font-size: 12px; color: #fff; padding: 5px 5px;" align="left">Medium</th>
                ...
                <tbody>
                    @foreach($recharge_histories as $key => $item)
                    <tr>
                        <td style="font-size: 10px;">{{ $key+1 }}</td>
                        <td style="font-size: 10px;">{{ $item->medium }}</td>
                        <td style="font-size: 10px;">{{ $item->trxno }}</td>
        ...
        <htmlpagefooter name="mySignatureNSealFooter">
            <em>Recharge history was created on a computer and is valid without the signature and seal.</em>
        </htmlpagefooter>
    </body>
</html>
