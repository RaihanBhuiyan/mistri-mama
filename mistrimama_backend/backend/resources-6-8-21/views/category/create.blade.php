...
<div class="panel">
    ...
    <div class="panel-body">
        <form id="exampleFullForm" autocomplete="off" method="POST" action="{{route('category.store')}}">
            @csrf
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input placeholder="Category Name" id="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('name') }}" name="name">
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <input placeholder="Category Name" id="name_bn" class="form-control {{ $errors->has('name_bn') ? 'is-invalid' : '' }}" value="{{ old('name_bn') }}" name="name_bn">
                    ...
                    <div class="form-group">
                        ...
                        <textarea placeholder="Write service benifits here" id="benifits" class="form-control {{ $errors->has('benifits') ? 'is-invalid' : '' }}" name="benifits" cols="50" rows="10">{{ old('benifits') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea placeholder="Write service benifits here" id="benifits_bn" class="form-control {{ $errors->has('benifits_bn') ? 'is-invalid' : '' }}" name="benifits_bn" cols="50" rows="10">{{ old('benifits_bn') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" name="position" placeholder="Position">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="example-wrap mb-4">
                                ...
                                <div class="example m-0" id="iconx" @error('icon') style="border: 1px solid #f44336;" @enderror>
                                    <input type="file" class="dropify" id="icon" name="icon" data-plugin="dropify" data-default-file=""/>
                                </div>
                                @if ($errors->has('icon'))
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="example-wrap mb-4">
                                ...
                                <div class="example m-0" id="opt_imagex" @error('opt_image') style="border: 1px solid #f44336;" @enderror>
                                    <input type="file" class="dropify" id="opt_image" name="opt_image" data-plugin="dropify" data-default-file=""/>
                                </div>
