...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">Client Cash Out Request</h3>
    </div>
    <div class="panel-body">
        @if(!empty($withdraw_requests))
        <div class="row">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('withdraw.deny', $request->id)}}" onClick="return confirm('Sure to deny cash out request?')" class="btn btn-xs btn-danger">Deny</a>
                        ...
                        <td>{{ $request->user->client ? $request->user->client->available_reward_balance : '0.00' }}</td>
