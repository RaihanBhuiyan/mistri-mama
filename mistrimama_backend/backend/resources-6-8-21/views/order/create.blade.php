                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="order_date" id="order_date" class="form-control">
                                ...
                                <option value="{{ $dates['date'] }}" {{ (date('d-F-Y') == $dates['date']) ? 'selected' : '' }}>{{ $dates['date'] }}-{{ $dates['day'] }}</option>
                                @endforeach
                                @endif
                            </select>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="order_time" id="order_time" class="form-control">
                                ...
                                <option value="{{ $times['time'] }}--{{ $times['is_office_hour'] }}" {{ ($times['checked']) ? 'selected' : '' }} >{{ $times['time'] }}</option>
                                @endforeach
                                @endif
                            </select>
