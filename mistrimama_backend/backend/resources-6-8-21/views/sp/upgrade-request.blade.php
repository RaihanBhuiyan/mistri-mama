...
<div class="page-header pl-20 pr-20 pb-20 pt-0">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Account Upgrade Request</li>
    </ol>
    <h1 class="page-title">Account Upgrade Request</h1>

</div>

<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">Account Upgrade Request </h3>
    </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{($i++)}}</td>
                        <td>
                            <a title="Deny" href="{{ route('service-provider.account-upgrade', [$serviceprovider->user_id, 'deny']) }}" class="btn btn-xs btn-danger" onClick="return confirm('Are you sure you want to Deny?')"><i class="icon md-close"></i></a>
                            <a title="Approve" href="{{ route('service-provider.account-upgrade', [$serviceprovider->user_id, 'approve']) }}" class="btn btn-xs btn-success" onClick="return confirm('Are you sure you want to Approve?')"><i class="icon md-check"></i></a>
                        ...
                        <td style="text-transform:capitalize">{{$serviceprovider->relCategoryUpgradeRequst->requested_category}}</td>
                        <td>
