...
<div class="panel">
    ...
    <div class="panel-body">
        <form id="exampleFullForm" autocomplete="off" method="POST" action="{{route('users.update', $user->id)}}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ $user->name }}" name="name" placeholder="Jane Doe">
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <input  type="tel" pattern="[0-9]*" maxlength="11" minlength="11"  class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" value="{{ $user->phone }}" name="phone" placeholder="017xxxxxxxx" readonly disable>
                        @if ($errors->has('phone'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" value="{{ $user->email }}" name="email" placeholder="email@email.com" readonly disable>
                        @if ($errors->has('email'))
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" rows="2" placeholder="Details Address">{{ $user->admin->address }}</textarea>
