...
<div class="panel" >
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                <!--  -->
                <form id="exampleFullForm" autocomplete="off" method="POST" action="{{route('zone.update',$zone->id)}}">
                    @method('patch')
                    @csrf
                            ...
                            <div class="form-group row form-material">
                                ...
                                <div class="col-xl-12 col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="{{$zone->name}}" name="name"
                            ...
                            <div class="form-group row form-material">
                                ...
                                <div class="col-xl-12 col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="{{$zone->code}}" name="code"
