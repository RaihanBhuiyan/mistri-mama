    ...
    <div class="panel-body">
        <div class="row collapse" id="addNewCategory">
            <div class="col-md-12">
                ...
                <form id="exampleFullForm" autocomplete="off" method="POST" action="{{route('baboharbidhi.index')}}" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="row collapse" id="addNewManual">
            <div class="col-md-12">
