                        ...
                        <tbody>
                            @forelse($entries as $key => $entry)
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        @if ($entry->hasStack())
                                        <a class="btn btn-xs btn-light" role="button" data-toggle="collapse"
            ...
            <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-xs btn-secondary mr-auto" data-dismiss="modal">Cancel</button>
