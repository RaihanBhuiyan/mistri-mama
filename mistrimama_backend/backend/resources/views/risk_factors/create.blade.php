...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">Add New Risk Factor</h3>
    </div>
    <div class="panel-body">
        <form id="exampleFullForm" autocomplete="off" method="POST" action="{{route('risk-factors.store')}}">
            @csrf
            <div class="form-row">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="particulars" value="{{ old('particulars') }}" id="particulars" placeholder="Relavent Questionnaire to Clam" rows="5">{{ old('particulars') }}</textarea>
