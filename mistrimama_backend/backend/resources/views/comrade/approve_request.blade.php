...
<div class="page-header pl-20 pr-20 pb-20 pt-0">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Approval Comrade</li>
    </ol>
...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">Approval Comrade</h3>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('comrade.deny', $comrade->id) }}" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure you want to Deny?')">Deny</a>
                        </td>
                        <td>
                        ...
                        <td style="text-transform:capitalize">{{(!empty($comrade->serviceProvider)) ? $comrade->serviceProvider->category : 'Service Provider Not Found'}}</td>
                        <td>
                        ...
                        <td>
                            <a href="javaScript:;" data-toggle="modal" data-target="#comradeNIDFBModal{{ $comrade->id }}">View NID front/ NID backce</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
@if(!empty($comrades))
@foreach ($comrades as $key =>  $comrade)
<div id="comradeNIDFBModal{{ $comrade->id }}" class="modal fade text-center" tabindex="-1">
