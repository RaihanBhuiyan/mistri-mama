...
<div class="page-header pl-20 pr-20 pb-20 pt-0">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Ongoing Order</li>
    </ol>
...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">Ongoing Order</h3>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('allocate.sp', [$order->category_id, $order->id])}}" class="badge badge-info btn btn-xs">Change SP</a>
