...
<div class="panel">
    <div class="panel-heading">
        <h3 class="panel-title">Add New On Demand User</h3>
    </div>
    <div class="panel-body">

        <form id="exampleFullForm" autocomplete="off" method="post"
            action="{{route('client.update',$onDemandClient->id)}}">
            @method('patch')
            @csrf
                    ...
                    <div class="form-group row form-material">
                        ...
                        <div class="col-xl-12 col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="{{$onDemandClient->name}}" name="name"
                    ...
                    <div class="form-group row form-material">
                        ...
                        <div class="col-xl-12 col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="{{$onDemandClient->phone}}" name="phone"
                    ...
                    <div class="form-group row form-material">
                        ...
                        <div class="col-xl-12 col-md-9">
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" value="{{$onDemandClient->email}}" name="email"
                    ...
                    <div class="form-group row form-material">
                        ...
                        <div class="col-xl-12 col-md-9">
                            <div class="input-group">
                                ...
                                <textarea class="form-control" name="address" rows="2" placeholder="Details Address"
                                    required="">{{$onDemandClient->address}}</textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="example-wrap m-0">
                                ...
                                <div class="example m-0" id="picture_upload">
                                    <input type="file" class="dropify" id="photo" name="photo" data-plugin="dropify"
                                        data-default-file="{{$onDemandClient->photo}}" />
                                </div>
                            </div>
                            <!-- End Example Default -->
                        </div>
                            ...
                            <div class="example-wrap m-0">
                                ...
                                <div class="example m-0" id="picture_upload">
                                    <input type="file" class="dropify" id="company_logo" name="company_logo"
                                        data-plugin="dropify" data-default-file="{{$onDemandClient->company_logo}}" />
                                </div>
                            </div>
                            <!-- End Example Default -->
                        </div>
                    ...
                    <div class="form-group row form-material">
                        ...
                        <div class="col-xl-12 col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="{{$onDemandClient->company_name}}"
                    ...
                    <div class="form-group row form-material">
                        ...
                        <div class="col-xl-12 col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="area" value="{{$onDemandClient->area}}">
                            </div>
                        </div>
                    </div>

                    <input type="text" name="type" value="ondemand" hidden>
