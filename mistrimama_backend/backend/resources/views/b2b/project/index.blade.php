...
<div class="page-header pl-20 pr-20 pb-20 pt-0">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">B2B Projects</li>
    </ol>
    <h1 class="page-title">B2B Projects</h1>
    <div class="page-header-actions">
        <a class="btn btn-sm btn-primary btn-round waves-effect waves-classic" href="{{route('projects.create')}}">
            <i class="icon md-plus" aria-hidden="true"></i>
            <span class="hidden-sm-down">Add New Projects</span>
        </a>
    </div>
</div>
