...
<div class="page-header pl-20 pr-20 pb-20 pt-0">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Affliation Clients</li>
    </ol>
    <h1 class="page-title">Affiliation Users</h1>
    <div class="page-header-actions">
        <a class="btn btn-sm btn-primary btn-round waves-effect waves-classic" href="{{route('affiliation.create')}}">
            ...
            <div class="example table-responsive">
                <table class="table table-stripped table-hover">
                    ...
                    <tbody>
                        ...
                        $i = 1;
                        @endphp
                        @foreach ($affiliationClients as $client)
                        <tr>
                            <td>{{$i}}</td>
                            <td>{{$client->name}}</td>
                            <td>{{$client->phone}}</td>
