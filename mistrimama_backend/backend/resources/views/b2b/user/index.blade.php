...
<div class="page-header pl-20 pr-20 pb-20 pt-0">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">B2B Users</li>
    </ol>
    <h1 class="page-title">B2B Users</h1>
    <div class="page-header-actions">
        <a class="btn btn-sm btn-primary btn-round waves-effect waves-classic" href="{{route('b2buser.create')}}">
