...
<div class="page-header pl-20 pr-20 pb-20 pt-0">
    ...
    <h1 class="page-title">Service Provider</h1>
    ...
    <div class="panel-body">
        ...
        <div class="example table-responsive">
            <table class="table">
                ...
                <tbody>
                    @foreach($serviceprovider as $key => $serviceprovider)
                    <tr>
                        <td>{{($key+1)}}</td>
                        <td>
                            ...
                            <a title="Edit" href="{{route('service-provider.edit', $serviceprovider->id)}}" class="btn btn-xs btn-info"><i class="icon md-edit"></i></a>
                            <a title="Download" href="{{route('service-provider-download', $serviceprovider->id)}}" class="btn btn-xs btn-warning"><i class="icon md-download"></i></a>
                        </td>
                        <td>
