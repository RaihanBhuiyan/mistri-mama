...
// transaction heading type array
function headingType($heading_type)
{
    $type = ['investment' => 'debit', 'expenses' => 'debit', 'revenue' => 'credit'];
    return $type[$heading_type];
}
