...
class OrderSystemController extends Controller
{
    ...
    public function AcceptByServiceProvider(Request $request)
    {
        ...
        if($order->status == 2)
        {
            return response(['message' => 'The order has been accpeted']);
            exit();
        } 
    ...
    public static function orderBillPaymentReceived($orderDetails, $serviceProvider)
    {
        ...
        if($orderDetails->pay_type > 1)
        {
            ...
            $mistrimama_income = [
                ...
                'details_bn' => '[অর্ডার  # '.$orderDetails->order_no.'] ডিজিটাল পেমেন্ট গ্রাহকের কাছ থেকে প্রাপ্ত .'.$discount_txt.''.$service_fee_txt.'',
                'ref' => 'order',
            ...
            $mistrimama_expanse = [
                ...
                'details_bn' => '[অর্ডার # '.$orderDetails->order_no.'] পরিষেবা অংশীদার কমিশন (ডিজিটাল).',
                'ref' => 'order',
                'ref_key' => $orderDetails->order_id,
            ];
            $service_provider_income = [
                ...
                'details_bn' => '[অর্ডার # '.$orderDetails->order_no.'] ডিজিটাল গ্রাহকের কাছ থেকে প্রাপ্ত .'.$discount_txt.''.$service_fee_txt.'',
                'ref' => 'order',
                'ref_key' => $orderDetails->order_id,
                'status' => 'credit',
            ];
            ...
            $client_expanse = [
                ...
                'details_bn' => '[অর্ডার # '.$orderDetails->order_no.'] পেমেন্ট গেটওয়ের মাধ্যমে মিস্ত্রি মামাকে সার্ভিস ফি ডিজিটাল পেমেন্ট.',
                'ref' => 'order',
                'ref_key' => $orderDetails->order_id,
            ];
        }
        else
        {
            ...
            $mistrimama_receive = [
                ...
                'details_bn' => '[অর্ডার # '.$orderDetails->order_no.'] গ্রাহকের কাছ থেকে নগদ প্রাপ্তি .'.$discount_txt.''.$service_fee_txt.'',
                'ref' => 'order',
                'ref_key' => $orderDetails->order_id,
            ];
            $mistrimama_income = [
                ...
                'type' => $type,
                'heading' => 'Order Commission',
                'details' => '[Order # '.$orderDetails->order_no.'] Mistri Mama Service Commission received from service partner.',
                'details_bn' => '[অর্ডার # '.$orderDetails->order_no.'] মিস্ট্রি মামা সার্ভিস কমিশন সার্ভিস পার্টনার থেকে পেয়েছে .',
                'ref' => 'order',
                'ref_key' => $orderDetails->order_id,
            ];
            ...
            $service_provider_expanse = [
                ...
                'details_bn' => '[অর্ডার # '.$orderDetails->order_no.'] মিস্ত্রি মামা সার্ভিস কমিশন .',
                'ref' => 'order',
                'ref_key' => $orderDetails->order_id,
            ];
            $client_expanse = [
                ...
                'details_bn' => '[অর্ডার # '.$orderDetails->order_no.'] মিস্ত্রি মামাকে সার্ভিস ফি নগদ অর্থ প্রদান .',
                'ref' => 'order',
                'ref_key' => $orderDetails->order_id,
            ];
        }
