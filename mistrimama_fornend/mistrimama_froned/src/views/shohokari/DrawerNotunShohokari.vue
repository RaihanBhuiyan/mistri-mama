            ...
            <v-container grid-list-xl fluid>
                <v-form lazy-validation @submit.prevent>
                    ...
                    <v-layout>
                        ...
                        <v-flex md4>
                            <v-text-field color="accent" clearable v-model="altPhoneNumber" prefix="+88" label="অতিরিক্ত ফোন *" placeholder="01XXXXXXXXX" :error-messages="display_errors.alt_phone"></v-text-field>
                        </v-flex>
                        <v-flex md4>
                            <v-text-field color="accent" clearable type="password"  autocomplete="off" v-model="password" label="পাসওয়ার্ড *" :error-messages="display_errors.password" placeholder="Enter your comrade password"></v-text-field>
                        </v-flex>
                    </v-layout>
                    <v-flex md12>
                        <v-select color="accent" item-text="name" item-value="id" :items="dialogitemsService" v-model="category" :error-messages="display_errors.services" label="ক্যাটাগরি *" :menu-props="{ maxHeight: '400' }" multiple persistent-hint></v-select>
                    </v-flex>
                    <v-flex md12>
