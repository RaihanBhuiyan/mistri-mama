                                ...
                                <v-layout row wrap v-if="schedule_charge != 0 || area_charge != 0 || discount != 0">
                                    ...
                                    <v-flex>
                                        <v-layout row wrap class="pl-3 pt-1" v-if="schedule_charge != 0">
                                            ...
                                            <v-flex xs3 sm3 md3 class="text-right"><span style="padding:0 10px">৳ {{ e2btransform(schedule_charge) }}</span></v-flex>
                                        </v-layout>
                                        <v-layout row wrap class="pl-3 pt-1" v-if="area_charge != 0">
                                            <v-flex xs9 sm9 md9>{{ $tc('extra_charge',2) }} </v-flex>
                                            <v-flex xs3 sm3 md3 class="text-right"><span style="padding:0 10px">৳ {{ e2btransform(area_charge) }}</span></v-flex>
                                        </v-layout>
                                    </v-flex>
                                </v-layout>
